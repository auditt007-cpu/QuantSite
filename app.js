...
const LEGAL = {
  ...
  tos: {
    ...
    // [PLAIN-TAG]
    body: "使用本站即表示您同意：本平台提供策略歷史試算展示、程式碼樣本與通知工具。您須自行遵守所在地法律。我們可因維護、合規或濫用行為中止服務。邀請與佣金以系統記錄為準，異常帳戶可被取消。",
  },
  privacy: {
  ...
  disclaimer: {
    ...
    // [REPLACE-TAG]
    // [PLAIN-TAG]
    body: "本平台所有策略、代碼與信號僅供策略歷史試算與學術研究，不構成任何投資建議與收益承諾。看板數據、買賣點標記與績效數字均為研究展示，不得視為真錢交易保證。使用者應獨立判斷並自行承擔全部風險。使用槓桿倍數進行模擬時，可能因市場極端波動導致本金全部損失，請審慎評估。",
  },
};
