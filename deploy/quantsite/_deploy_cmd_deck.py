...
def main():
    ...
    puts = [
        ...
        (REPO / "strategies.html", "/var/www/html/strategies.html"),
        (REPO / "strategies.json", "/var/www/html/strategies.json"),
        (REPO / "js/plaza-ai.js", "/var/www/html/js/plaza-ai.js"),
        (REPO / "js/terminal.js", "/var/www/html/js/terminal.js"),
        (REPO / "css/plaza-cards.css", "/var/www/html/css/plaza-cards.css"),
        (REPO / "css/bloomberg-system.css", "/var/www/html/css/bloomberg-system.css"),
        (REPO / "css/mobile-global.css", "/var/www/html/css/mobile-global.css"),
        (REPO / "styles.css", "/var/www/html/styles.css"),
        (REPO / "index.html", "/var/www/html/index.html"),
        (REPO / "about.html", "/var/www/html/about.html"),
        (REPO / "member.html", "/var/www/html/member.html"),
        (REPO / "affiliate.html", "/var/www/html/affiliate.html"),
        (REPO / "terminal.html", "/var/www/html/terminal.html"),
